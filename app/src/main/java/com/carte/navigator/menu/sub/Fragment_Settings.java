...
public class Fragment_Settings extends Fragment implements Interface_RecyclerView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView.Adapter<Adapter_Account_Settings.OptionViewHolder>  adapter_settings_general = new Adapter_Account_Settings(this,getContext(),settings_general,3,false,false);//(Professor Sluiter, 2020).
        recyclerView_general_settings.setAdapter(adapter_settings_general);

        RecyclerView.Adapter<Adapter_Account_Settings.OptionViewHolder>  adapter_settings_navigation = new Adapter_Account_Settings(this,getContext(),settings_navigation,4,false,false);//(Professor Sluiter, 2020).
